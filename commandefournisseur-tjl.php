...
<body>
   <div class="Content">
      <header class="HeaderLogo">
         ...
         <a href="index.php"><h1 class="HeaderTitle">Article saisie</h1></a>
      </header>
      <div class="WrapperWithBar">
        ...
        <div class="FooterBar">
           ...
           <div class="Bar BarGrey"><a href="#" class="BarOption BarGrey"><img class="Arrow" src="img/arrow-left.svg"></></a></div>
           <div class="Bar BarGrey"><a href="#" class="BarOption BarGrey"><img class="Arrow" src="img/arrow-blue-right.svg"></></a></div>
